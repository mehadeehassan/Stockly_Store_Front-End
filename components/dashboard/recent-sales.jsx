  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[#ECE3D8] bg-white">
      <div className="border-b border-[#ECE3D8] px-5 py-4">
        <h2 className="text-base font-semibold text-[#241C14]">Recent Transactions</h2>
      </div>
          ...
          <tbody>
            {RECENT_SALES.map((s) => (
              ...
              >
                ...
                <td className="px-5 py-3.5 text-xs text-[#241C14]">{s.customer}</td>
                <td className="px-5 py-3.5 text-xs text-[#8A7B6C]">{s.cashier}</td>
                <td className="px-5 py-3.5 text-xs text-[#8A7B6C]">{s.items} items</td>
                <td className="px-5 py-3.5">
                ...
                <td className="px-5 py-3.5">
                  <span className="text-xs capitalize text-[#8A7B6C]">{s.method}</span>
                </td>
                <td className="px-5 py-3.5">
                  <span
